...
CREATE TABLE MEMBER
(
	MEMNER_ID INT NOT NULL UNIQUE AUTO_INCREMENT COMMENT '会員ID',
	...
	MEMBER_PASSWORD VARCHAR(50) NOT NULL COMMENT '会員パスワード',
	PRIMARY KEY (MEMNER_ID)
) COMMENT = '会員';
...
(
	...
	MEMNER_ID INT COMMENT '会員ID',
	TWEET_MESSAGE VARCHAR(140) COMMENT 'ツイート内容',
...
ALTER TABLE TWEET
	ADD FOREIGN KEY (MEMNER_ID)
	REFERENCES MEMBER (MEMNER_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
